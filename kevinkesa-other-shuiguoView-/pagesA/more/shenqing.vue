	...
	<view class="bodys">
		...
		<view class="center">
			<view class="center_common">
				<view class="center_common_title">店铺姓名</view>
			...
			<view class="center_common">
				...
				<view class="center_common_inputs" @click="$gonext('/pages/map/selectMap')">
			...
			<view class="center_common">
				...
				<view class="center_common_inputs">
					<u-input v-model="admin_pwd" :clearable="false" style="width: 430rpx;" :type="type" :border="border" placeholder="管理员后台登录密码(必填)" /></view>
			</view>

		</view>
		<view class="btn"  @click='change()'>注册商家</view>
